...
void ImageLabel::init()
{
    ...
    this->onUpdateUseBlob(d->mConfigInformation->getIsUseBlob());
    ...
    connect(d->mConfigInformation, &ConfigInformation::onChangedIsUseBlob, this, &ImageLabel::onUpdateUseBlob);
...
void ImageLabel::onUpdateUseBlob(bool configData)
{
    d->mIsUseBlob = configData;
}
