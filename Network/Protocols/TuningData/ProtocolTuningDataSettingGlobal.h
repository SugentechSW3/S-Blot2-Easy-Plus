...
enum TUNING_DATA_GLOBAL
{
    ...
    TUNING_DATA_GLOBAL_GUIDE_LINE_ROI_X1, //0x0c
...
enum TUNING_DATA_CONTENTS_ANALYSIS
{
    ...
    TUNING_DATA_CONTENTS_ANALYSIS_USE_BLOB_BAND, //deprecated protocol
    TUNING_DATA_CONTENTS_ANALYSIS_USE_MULTI_BAND,
    TUNING_DATA_CONTENTS_ANALYSIS_DEPRECATED,
    TUNING_DATA_CONTENTS_ANALYSIS_MULTIPLE_BAND_X4_START,
    TUNING_DATA_CONTENTS_ANALYSIS_MULTI_BAND_PC_THRES,
    TUNING_DATA_CONTENTS_ANALYSIS_PC_X_END,
    TUNING_DATA_CONTENTS_ANALYSIS_MULTIPLE_BAND_X4_GAP,

    TUNING_DATA_CONTENTS_ANALYSIS_MULTIPLE_BAND_X2_START = 30,
    TUNING_DATA_CONTENTS_ANALYSIS_MULTIPLE_BAND_X3_START,
    TUNING_DATA_CONTENTS_ANALYSIS_MULTIPLE_BAND_X2_GAP,
    TUNING_DATA_CONTENTS_ANALYSIS_MULTIPLE_BAND_X3_GAP,

    TUNING_DATA_CONTENTS_BOX_CAR_BAND_GAP_IDX = 40
};
